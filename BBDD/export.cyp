...
'https://raw.githubusercontent.com/cdiezg07/SIBI-FOODRATE/main/nuevoooooMemoria.csv?token=ALKVWTVXBX3AZZJCD72ECMDBYZNBW' as row
...
FROM "https://raw.githubusercontent.com/cdiezg07/SIBI-FOODRATE/main/nuevooooo.csv?token=ALKVWTRV3VPJE3UIPP5GXNTBUE7RQ" AS row
MATCH (r:Receta {id: row.name})
MERGE (i:Ingredientes {value: row.ingredientes})
CREATE (r)-[:CONTIENE_INGREDIENTES]->(i)

LOAD CSV WITH HEADERS FROM
'https://raw.githubusercontent.com/cdiezg07/SIBI-FOODRATE/main/nuevooooo.csv?token=ALKVWTTL4VXNBHZXENH7PQTBUTG6M' AS row with row,
